...
$publishDir = Join-Path $env:TEMP "HackerRank1-monsterasp-publish"
...
if (-not $msdeploy) {
    throw "No se encontro msdeploy.exe. Instala Web Deploy 3.x o publica desde Visual Studio con el perfil Investigacion-WebDeploy."
}
